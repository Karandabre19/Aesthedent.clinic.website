...
export const insights = [
  {
    ...
    // The headline above reads well on the page but runs to 66 chars once the
    // brand is appended, so it truncates in search results. metaTitle is an
    // optional shorter form used for <title> only; omit it and the title is used.
    metaTitle: 'Why a Prosthodontist for Dental Implants?',
    ...
    featured: true,
    keywords: ['dental implants pune', 'prosthodontist', 'specialist dental care'],
  },
  {
    id: 2,
