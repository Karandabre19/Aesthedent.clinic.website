  ...
  return (
    <PageWrapper>
        ...
        <div className="main-container">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <Badge className="mb-4 bg-[hsl(var(--color-primary))]/10 text-[hsl(var(--color-primary))] hover:bg-[hsl(var(--color-primary))]/20">Service</Badge>
      ...
      <section className="section-spacing">
        <div className="main-container">
          <AnimatedSection className="text-center mb-12">
            <Badge className="mb-4 bg-[hsl(var(--color-primary))]/10 text-[hsl(var(--color-primary))]">Benefits</Badge>
      ...
      <section className="section-spacing bg-gradient-to-b from-[hsl(var(--color-primary))]/10 to-[hsl(var(--background))]">
        <div className="main-container-narrow">
          <AnimatedSection className="text-center mb-12">
            <Badge className="mb-4 bg-[hsl(var(--color-primary))]/20 text-[hsl(var(--color-primary))]">The Process</Badge>
            <h2 className="text-2xl lg:text-3xl font-semibold text-[hsl(var(--color-text))]">
              What to Expect
            </h2>
          </AnimatedSection>
              ...
              <AnimatedSection key={i} delay={i * 0.15}>
                <div className="flex gap-6 items-start">
                  ...
                  <div className="bg-[hsl(var(--background))] rounded-2xl p-6 flex-1 border border-[hsl(var(--border))] shadow-sm">
                    <h4 className="font-semibold text-[hsl(var(--color-text))] text-lg mb-2">{step.title}</h4>
                    <p className="text-[hsl(var(--color-text-muted))]">{step.desc}</p>
                  </div>
                </div>
              </AnimatedSection>
            ))}
      ...
      <section className="section-spacing">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <Badge className="mb-4 bg-[hsl(var(--color-primary))]/10 text-[hsl(var(--color-primary))]">FAQs</Badge>
            <h2 className="text-2xl lg:text-3xl font-semibold text-[hsl(var(--color-text))]">
              Common Questions
            </h2>
          </AnimatedSection>
          ...
          <div className="space-y-4">
            {service.faqs.map((faq, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <div 
                  className="bg-[hsl(var(--background))] rounded-2xl border border-[hsl(var(--border))] overflow-hidden hover:border-[hsl(var(--color-primary))] transition-colors"
                >
                  <button
                    onClick={() => setOpenFaq(openFaq === i ? null : i)}
                    className="w-full flex items-center justify-between p-6 text-left"
                  >
                    <span className="font-semibold text-[hsl(var(--color-text))] pr-4">{faq.q}</span>
                    <ChevronDown className={`w-5 h-5 text-[hsl(var(--color-text-muted))] transition-transform ${openFaq === i ? 'rotate-180' : ''}`} />
                  </button>
                  {openFaq === i && (
                    <motion.div
                      ...
                      className="px-6 pb-6"
                    >
                      <p className="text-[hsl(var(--color-text-muted))]">{faq.a}</p>
                    </motion.div>
                  )}
                </div>
              </AnimatedSection>
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-[hsl(var(--primary-foreground))] text-[hsl(var(--primary-foreground))] hover:bg-[hsl(var(--primary-foreground))]/10 px-8 py-6"
                asChild
              >
                <a href={`tel:${phoneNumber}`}>
                  <Phone className="w-5 h-5 mr-2" />
