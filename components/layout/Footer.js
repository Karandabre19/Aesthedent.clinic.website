      ...
      <div className="main-container py-24 lg:py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24 lg:gap-28">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[hsl(var(--primary-foreground))]/85 text-sm leading-relaxed font-light mb-10 tracking-wide">
          ...
          {/* Services */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-[0.15em] text-[hsl(var(--color-accent))] mb-10 pb-4 border-b border-[hsl(var(--color-accent))]/30">Services</h4>
            <ul className="space-y-5">
              {footerLinks.services.map((link) => (
                <li key={link.href}>
                  <Link 
                    href={link.href}
                    className="text-[hsl(var(--primary-foreground))]/80 hover:text-[hsl(var(--color-accent))] transition-colors duration-300 text-sm font-light hover:translate-x-1 transform transition-transform"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-[0.15em] text-[hsl(var(--color-accent))] mb-10 pb-4 border-b border-[hsl(var(--color-accent))]/30">Quick Links</h4>
            <ul className="space-y-5">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-[0.15em] text-[hsl(var(--color-accent))] mb-10 pb-4 border-b border-[hsl(var(--color-accent))]/30">Contact</h4>
            <ul className="space-y-6">
              <li className="flex items-start gap-3.5 group">
                ...
                <span className="text-[hsl(var(--primary-foreground))]/85 text-sm font-light leading-relaxed">Near Karve Statue, Kothrud, Pune, Maharashtra 411038</span>
              </li>
              <li className="flex items-start gap-3.5 group">
                ...
                <span className="text-[hsl(var(--primary-foreground))]/85 text-sm font-light leading-relaxed">Mon - Sat: 10:00 AM - 8:00 PM</span>
              </li>
              <li className="flex items-start gap-3.5 group">
                ...
                <a href={`tel:${phoneNumber}`} className="text-[hsl(var(--primary-foreground))]/85 text-sm hover:text-[hsl(var(--color-accent))] transition-colors duration-300 font-light">
                  +91 98765 43210
                </a>
              </li>
              <li className="flex items-start gap-3.5 group">
                ...
                <a href="mailto:info@aesthedent.com" className="text-[hsl(var(--primary-foreground))]/85 text-sm hover:text-[hsl(var(--color-accent))] transition-colors duration-300 font-light break-all">
                  info@aesthedent.com
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[hsl(var(--primary-foreground))]/75 text-xs font-light tracking-widest">
            © 2025 Aesthedent Dental Clinic. All rights reserved.
          </p>
          <div className="flex gap-10 text-xs">
            <Link href="/privacy" className="text-[hsl(var(--primary-foreground))]/75 hover:text-[hsl(var(--color-accent))] transition-colors duration-300 font-light">Privacy Policy</Link>
            <Link href="/terms" className="text-[hsl(var(--primary-foreground))]/75 hover:text-[hsl(var(--color-accent))] transition-colors duration-300 font-light">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
